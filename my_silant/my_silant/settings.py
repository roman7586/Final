"""
Django settings for my_silant project.
...
SECRET_KEY = 'django-insecure-o5p#2w(yrw*oap&m)9fbk)=6!)4-fhp6njpjoxpm^x0y-+$%j_'
...
#Для переопределение allauth, отключения регистрации
